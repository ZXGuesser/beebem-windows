...
Root: HKLM; Subkey: "Software\Classes\.uef\OpenWithProgIds";                   ValueType: string; ValueName: "BeebEm.uef";      ValueData: "";                            Flags: uninsdeletevalue; Check: CheckAddFileAssociation('uef')
Root: HKLM; Subkey: "Software\Classes\BeebEm.uef";                             ValueType: string; ValueName: "";                ValueData: "BBC Micro UEF File";          Flags: uninsdeletekey;   Check: CheckAddFileAssociation('uef')
...
Root: HKLM; Subkey: "Software\Classes\.uefstate\OpenWithProgIds";              ValueType: string; ValueName: "BeebEm.uefstate"; ValueData: "";                            Flags: uninsdeletevalue; Check: CheckAddFileAssociation('uefstate')
Root: HKLM; Subkey: "Software\Classes\BeebEm.uefstate";                        ValueType: string; ValueName: "";                ValueData: "BeebEm Saved State";          Flags: uninsdeletekey;   Check: CheckAddFileAssociation('uefstate')
